...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="titles">Genres</h2>   <!-- TODO switch to SEARCH BY GENRE -->
			<hr/>			
			<div class="row text-center slick-multislider">
				<c:forEach var="genres" items="${genreList}">
					<div class="large-4 small-12 columns">
						...
						<h5 class="h5-title-margin-top"><a href="${context}/GenrePage?id=${genres.id}">${genres.genre}</a></h5>  <!-- TODO switch to SEARCH BY GENRE -->
					</div>
				</c:forEach>
			</div>
			...
			<div class="row text-center slick-multislider">
				<c:forEach var="movies" items="${randomList}">
					<div class="large-4 small-12 columns">						
						<h5 class="h5-title-margin-top">${movies.title}</h5>					
						<a href="${context}/MoviePage?id=${movies.id}"><img src="${movies.banner} alt="Image not found" onError="this.src='http://placehold.it/700x300';" width="700" height="300"/></a>
